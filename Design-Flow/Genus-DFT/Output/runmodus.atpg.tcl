...
#-------------------------------------------------------------------------------
build_model \
    -cell	 systolic_array_top \
    -techlib	 /linuxeda_new/c2scadence/FOUNDRY/digital/90nm/dig/vlog/slow.v \
    -designsource	 $WORKDIR/systolic_array_top.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/systolic_array_top.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 systolic_array_top_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_systolic_array_top_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 systolic_array_top_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_systolic_array_top_atpg
...
check_log log_commit_tests_FULLSCAN_systolic_array_top_atpg
